...
class giochino(arcade.Window):
    def __init__(self, larghezza, altezza, titolo):
        ...
        # Variabili del mondo
        self.larghezza_livello = 2000 
        self.GRAVITY = 1.0
        self.PLAYER_JUMP_SPEED = 18
        self.velocita = 5
    ...
    def setup(self):
        ...
        # 3. Personaggio
        self.character = arcade.Sprite("Wizard Pack/mago fermo.png")
        self.character.center_x = 300
        self.character.center_y = 150 # Parte in aria e cade
        self.character.scale = 0.2
